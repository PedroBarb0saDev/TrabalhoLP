...
public class JDlgVendedorConsulta extends javax.swing.JDialog {
    ...
    /**
     * Creates new form JDlgVendedorConsulta
     */
    public JDlgVendedorConsulta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Vendedor Consulta");
...
//        List lista = usuario_DAO.listALL();
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        ...
        if (jTxtNome.getText().equals("") && jTxtCpf.getText().equals("")) {
            lista = vendedor_DAO.listALL();

        } else {
            if (!jTxtNome.equals("") && !jTxtCpf.equals("")) {
                lista = vendedor_DAO.listNomeCpf(jTxtNome.getText(), jTxtCpf.getText());
            } else {

                if (!jTxtNome.getText().equals("")) {

                } else {
                    lista = vendedor_DAO.listCpf(jTxtCpf.getText());
                }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgVendedorConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgVendedorConsulta dialog = new JDlgVendedorConsulta(new javax.swing.JFrame(), true);
