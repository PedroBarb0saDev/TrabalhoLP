...
public class JDlgProdutoNovo extends javax.swing.JDialog {
    ...
    private void jBtnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAlterarActionPerformed
        ...
        ProdutoPhsb produtoPhsb =  produtoControle.getBean(rowSel);
    ...
    private void jBtnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnExcluirActionPerformed
        ...
        if (Util.pergunta("Deseja execluir o registro") == true ) {
            ...
            produtoPhsb = produtoControle.getBean(sel);
            produto_DAO.delete(produtoPhsb);
            //atualizar a lista no jtable
            List lista = produto_DAO.listALL();
            produtoControle.setList(lista);
            Util.mensagem("exclusão feita");
